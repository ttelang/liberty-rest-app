...
To get the code from the MicroProfile tutorial branch:
...
# Checkout the microprofile tutorial branch
git checkout microprofile/microprofile-tutorial

# Pull the latest changes
git pull origin microprofile/microprofile-tutorial
